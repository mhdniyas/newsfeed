...
{
    protected $signature = 'news:fetch {--section= : Specific section ID to fetch} {--topic= : Specific topic ID to fetch} {--limit=60 : Maximum new articles to save in one run}';
    ...
    public function handle(): int
    {
        ...
        $limit = max(1, min(60, (int) $this->option('limit')));
